...
- [ ] Image (300×200 pixels) named `cover.jpg` or `cover.svg` to use as cover
...
- [ ] Image (300×200 pixels) to use as cover and associated metadata in the YAML header block at the begin of the Markdown file defining
...
- [ ] Complete author details, including affiliation
- [ ] Image (300×200 pixels) to use as cover and associated metadata in the YAML header block in the first cell of the Jupyter Notebook defining
